...
public class NotificationController {
    ...
    public String getNotifications(@CurrentAccount Account account, Model model) {
        ...
        putCategorizeNotifications(model, notifications, numberOfChecked, notifications.size());
    ...
    public String getOldNotifications(@CurrentAccount Account account, Model model) {
        ...
        putCategorizeNotifications(model, notifications, notifications.size(), numberOfNotChecked);
    ...
    private void putCategorizeNotifications(Model model, List<Notification> notifications,
